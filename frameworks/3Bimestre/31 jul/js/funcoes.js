 function carregarBanco() {
    document.getElementById("carregando").innerHTML="<img src='https://upload.wikimedia.org/wikipedia/commons/b/b1/Loading_icon.gif' style='width:25%; heigth:25%;text-align:center;'>";
